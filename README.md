...
```sh
npm install --save-dev @vipstorage/prisma-generator-nestjs-dto
```
...
All files are released under the [Apache License 2.0](https://github.com/128keaton/prisma-generator-nestjs-dto/blob/master/LICENSE).
